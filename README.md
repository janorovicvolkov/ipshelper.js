...
IPSHelper adalah sebuah perkakas ringan berbasis JavaScript yang dirancang untuk membantu pemeriksa dan petugas IPS Wikipedia bahasa Indonesia dalam menangani laporan [investigasi pengguna siluman][].
IPSHelper bisa digunakan jika pengguna merupakan seorang petugas IPS, ataupun memiliki hak pengurus maupun pemeriksa. Perkakas ini dikembangkan oleh [Janorovic Volkov][].

📖 Baca selengkapnya di Wikipedia bahasa Indonesia: [Wikipedia:IPSHelper.js][]
...
[Janorovic Volkov]: https://id.wikipedia.org/wiki/Pengguna:Janorovic_Volkov
